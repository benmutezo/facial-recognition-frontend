...
class Signin extends Component {
    ...
    onSubmitSignIn = () => {
        fetch("https://agile-ocean-22305.herokuapp.com/signin", {
            method: "post",
            ...
            <article className="br3 shadow-5  grow ba mv4 w-100 w-50-m w-25-l mw6 center ">
                <main className="pa4 black-80">
                    <div className="measure tc">
                        ...
                        <div className="">
                            <input onClick={this.onSubmitSignIn} className="b   ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib br3" type="submit" value="Sign in" />
                        </div>
